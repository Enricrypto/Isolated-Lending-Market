...
function HealthBar({ value }: { value: number }) {
  ...
  const color =
    value >= 2.0 ? "bg-emerald-500" : value >= 1.5 ? "bg-yellow-500" : value >= 1.2 ? "bg-orange-500" : "bg-red-500";
  return (
      ...
      <div className="p-6 sm:p-8 lg:p-10">
        ...
        <div className="mb-8 relative">
          ...
          <p className="text-slate-400 text-sm max-w-2xl font-light leading-relaxed">
            Borrow against your collateral. Debt and health factor are served from the
            indexer — no direct chain reads for protocol state.
          </p>
                ...
                {markets.map((market) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <TokenIcon symbol={market.symbol} size={22} />
                      </div>
